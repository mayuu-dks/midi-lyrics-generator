        ...
        <div className="mt-4 p-4 border rounded-lg bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800 text-sm">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            {language === 'ja' ? (
              <>
                ...
                <li>最新のAIモデル <strong>OpenAI GPT-4o</strong>、<strong>Google Gemini-1.5-pro</strong>、または <strong>Google Gemini Pro</strong> を使用（APIキーは右上の設定ボタンから設定可能）</li>
              ...
              <>
                ...
                <li>Uses the latest AI models <strong>OpenAI GPT-4o</strong>, <strong>Google Gemini-1.5-pro</strong>, or <strong>Google Gemini Pro</strong> (set API key via settings button in the top-right)</li>
          ...
          <div className="mt-3 text-xs flex flex-wrap gap-3">
            <div className="flex items-center bg-blue-100 dark:bg-blue-900/30 px-2 py-1 rounded">
              ...
              {language === 'ja' 
                ? `使用AIモデル: ${apiProvider === 'openai' ? 'OpenAI GPT-4o' : apiProvider === 'google' ? 'Google Gemini-1.5-pro' : 'Google Gemini Pro'}` 
                : `AI Model: ${apiProvider === 'openai' ? 'OpenAI GPT-4o' : apiProvider === 'google' ? 'Google Gemini-1.5-pro' : 'Google Gemini Pro'}`}
            </div>
            <div className="flex items-center bg-blue-100 dark:bg-blue-900/30 px-2 py-1 rounded">
              <span className="inline-block w-2 h-2 rounded-full bg-blue-500 mr-2"></span>
