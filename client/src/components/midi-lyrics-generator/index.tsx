          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            {language === 'ja' ? (
              <>
                ...
                <li>最新のAIモデル <strong>OpenAI GPT-4o</strong> または <strong>Google Gemini-1.5-pro</strong> を使用（APIキーは右上の設定ボタンから設定可能）</li>
              ...
              <>
                ...
                <li>Uses the latest AI models <strong>OpenAI GPT-4o</strong> or <strong>Google Gemini-1.5-pro</strong> (set API key via settings button in the top-right)</li>
